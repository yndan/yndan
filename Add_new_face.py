...
if name in os.listdir('faces/train'):
    ...
    while i<=200:
        ...
        if i%5==0 and i<=150 and i!=0:
            ...
            cv2.imwrite('faces/test/'+name+'/'+str(i)+'.png',frame)
        i+=1
...
# embedding_model = load_model('models/keras_model.h5')
